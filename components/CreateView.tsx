        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 relative animate-in zoom-in-95 duration-300">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500 text-sm">Just enter your email to sign up or log in to Mindtrip.</p>
            </div>
            ...
            <p className="text-[10px] text-gray-400 text-center mt-6 leading-tight">
              By continuing, you agree to Mindtrip’s <span className="font-bold text-gray-500">Terms of Service</span> and acknowledge you’ve read our <span className="font-bold text-gray-500">Privacy Policy</span>.
            </p>
